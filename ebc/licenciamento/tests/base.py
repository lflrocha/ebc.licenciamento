...
def setup_product():
    ...
    import ebc.licenciamento
    zcml.load_config('configure.zcml', ebc.licenciamento)
    ...
    ztc.installPackage('ebc.licenciamento')
...
setup_product()
ptc.setupPloneSite(products=['ebc.licenciamento'])
